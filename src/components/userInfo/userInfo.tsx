...
export default function UserInfo(userData: UserDataProps) {
  const [finalUserData, setFinalUserData] = useState<UserDataProps | null>(
    null,
  );
    ...
    <div className={styles.userInfo}>
      <div className={styles.profilebox}>
        <img
          ...
          src={getImgSrc(Number(finalUserData?.imgId))}
        />
      </div>
      <div className={styles.infobox}>
        <div>
          ...
          <div className={styles.listItems}>
            ...
            <p>{getDaysAgo(String(finalUserData?.createdAt))}</p>
          </div>
          <div className={styles.listItems}>
